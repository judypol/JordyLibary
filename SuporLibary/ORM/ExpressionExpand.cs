...
namespace JordyLibary.ORM
{
    ...
    public partial class Expression
    {
        ...
        public IList<T> List<T>(string connName, params string[] orderby) where T : Mappings.DataObject, new()
        {
        ...
        public IList<T> List<T>(string connName, Region region) where T : Mappings.DataObject, new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public IList<T> List<T>(string connName, Region region, params string[] orderby) where T : Mappings.DataObject, new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                Type type = typeof(T);
        ...
        public IList<RESULT> List<T, RESULT>(string connName, Region region)
            where T : Mappings.DataObject, new()
            where RESULT : new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
        ...
        public IList<RESULT> List<T, RESULT>(string connName, params string[] orderby)
            where T : Mappings.DataObject, new()
            where RESULT : new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
        ...
        public IList<RESULT> List<T, RESULT>(string connName, Region region, params string[] orderby)
            where T : Mappings.DataObject, new()
            where RESULT : new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
        ...
        public RESULT ListFirst<T, RESULT>(string connName)
            where T : Mappings.DataObject, new()
            where RESULT : new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
        ...
        public RESULT ListFirst<T, RESULT>(string connName, params string[] orderby)
            where T : Mappings.DataObject, new()
            where RESULT : new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
        ...
        public T ListFirst<T>(string connName) where T : Mappings.DataObject, new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public T ListFirst<T>(string connName, params string[] orderby) where T : Mappings.DataObject, new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return ListFirst<T>(cc, orderby);
        ...
        public int Delete<T>(string connName) where T : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return Delete<T>(cc);
        ...
        public int Edit<T>(string connName, Action<T> handler) where T : DataObject, new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public int Edit<T>(string connName, params Field[] fields) where T : DataObject, new()
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return Edit<T>(cc, fields);
        ...
        public int Count<T>(string field, string connName) where T : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public int Count<T>(string field, bool DISTINCT, string connName) where T : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return Count<T>(field, DISTINCT, cc);
        ...
        public RESULT Sum<RESULT, Entity>(string field, string connName) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public RESULT Sum<RESULT, Entity>(string field, bool DISTINCT, string connName) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return Sum<RESULT, Entity>(field, DISTINCT, cc);
        ...
        public RESULT Max<RESULT, Entity>(string field, string connName) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public RESULT Max<RESULT, Entity>(string field, bool DISTINCT, string connName) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return Max<RESULT, Entity>(field, DISTINCT, cc);
        ...
        public RESULT Min<RESULT, Entity>(string field, string connName) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public RESULT Min<RESULT, Entity>(string field, bool DISTINCT, string connName) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return Min<RESULT, Entity>(field, DISTINCT, cc);
        ...
        public RESULT Avg<RESULT, Entity>(string field, string connName) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public RESULT Avg<RESULT, Entity>(string field, bool DISTINCT, string connName) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return Avg<RESULT, Entity>(field, DISTINCT, cc);
        ...
        public RESULT GetValue<RESULT, Entity>(IFieldInfo field, string connName, params string[] orderby) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public IList<RESULT> GetValues<RESULT, Entity>(IFieldInfo field, string connName, int pageindex, int pagesize) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
        ...
        public IList<RESULT> GetValues<RESULT, Entity>(IFieldInfo field, string connName, Region region, params string[] orderby) where Entity : Mappings.DataObject
        {
            using (IConnectinContext cc = DBContext.GetConnection(connName))
            {
                return GetValues<RESULT, Entity>(field, cc, region, orderby);
