...
namespace JordyLibary.Core
{
    ...
    public class Utils
    {
        ...
        private Utils()
        { }
        private static string mRanSeed = "abcdefghijklmnopqrstuvwxyz";  //随机数种子
        /// <summary>
        /// 获取一个指定长度的字符串
        /// </summary>
        ...
        public static T[] GetFieldAttributes<T>(FieldInfo field,bool inhert)
            where T:Attribute
        {
        ...
        public static bool AppSettingValue(string name,string value)
        {
