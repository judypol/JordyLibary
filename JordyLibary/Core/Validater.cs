...
namespace JordyLibary.Core
{
    ...
    public abstract class ValidaterAttribute : Attribute
    {
        ...
        public bool Validating(object value, object source, PropertyMapper pm, IConnectinContext cc)
        {
        ...
        /// <param name="cc">数据库上下文</param>
        /// <returns>bool</returns>
        protected abstract bool OnValidating(object value, object source, PropertyMapper pm, IConnectinContext cc);
        /// <summary>
        /// 验证返回的信息
        /// </summary>
