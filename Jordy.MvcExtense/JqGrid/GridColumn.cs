...
namespace Jordy.MvcExtense.JqGrid
{
    public class GridColumn
    {
        ...
        public GridColumn AddClass(string className)
        {
        ...
        public GridColumn SetSearchDateFormat(string searchDateFormat)
        {
        ...
        public GridColumn SetSearchTerms(string[] searchTerms)
        {
        ...
        public GridColumn SetClearSearch(bool clearSearch)
        {
        ...
        /// </summary>
        /// <param name = "searchTerms">Searchterm to add to dropdownlist</param>
        public GridColumn SetSearchTerms(IDictionary<string, string> searchTerms)
        {
        ...
        public GridColumn SetAlign(Align align)
        {
            _align = align;
            return this;
        }
        ...
        public GridColumn SetFirstSortOrder(SortOrder firstSortOrder)
        {
        ...
        public GridColumn SetFixedWidth(bool fixedWidth)
        {
        ...
        public GridColumn SetFormatter(Formatters formatter)
        {
        ...
        public GridColumn SetFormatter(Formatters formatter, string formatOptions)
        {
            if (!_customFormatter.IsNullOrWhiteSpace())
            {
                throw new Exception(
        ...
        /// <returns></returns>
        public GridColumn SetCustomFormatter(string customFormatter)
        {
        ...
        public GridColumn SetHidden(bool hidden)
        {
            _hidden = hidden;
            return this;
        }
        ...
        public GridColumn SetIndex(string index)
        {
            _index = index;
            return this;
        }
        ...
        public GridColumn SetKey(bool key)
        {
            _key = key;
            return this;
        }
        ...
        public GridColumn SetResizeable(bool resizeable)
        {
        ...
        public GridColumn SetSearch(bool search)
        {
            _search = search;
            return this;
        }
        ...
        public GridColumn SetSortable(bool sortable)
        {
            _sortable = sortable;
            return this;
        }
        ...
        public GridColumn SetTitle(bool title)
        {
            _title = title;
            return this;
        }
        ...
        public GridColumn SetDefaultSearchValue(string defaultSearchValue)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public GridColumn SetAsExpandable()
        {
        ...
        public GridColumn SetSearchOption(SearchOptions searchOption)
        {
        ...
        /// <returns></returns>
        public GridColumn SetEditable(bool editable)
        {
            _editable = editable;
            return this;
        }
        ...
        /// <returns></returns>
        public GridColumn SetEditType(EditType editType)
        {
            _editType = editType;
            return this;
        }
        ...
        /// <returns></returns>
        public GridColumn SetEditOptions(EditOptions editOptions)
        {
        ...
        /// <returns></returns>
        public GridColumn SetEditFormOptions(EditFormOptions editFormOptions)
        {
            _editFormOptions = editFormOptions;
            return this;
        }

        public GridColumn SetSortType(SortType sortType)
        {
            _sortType = sortType;
            return this;
        }
